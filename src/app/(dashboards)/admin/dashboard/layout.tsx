...
import { AppSidebar } from "@/app/(dashboards)/hospital/_components/dashboard-stuffs/app-sidebar"
import { SiteHeader } from "@/app/(dashboards)/hospital/_components/dashboard-stuffs/site-header"
...
export default function HospitalDashboardLayout({ children }: DashboardLayoutProps) {
  return (
    <AuthProvider requiredRole="hospital">
      <DashboardContent>
        {children}
      </DashboardContent>
    </AuthProvider>
