...
import { AppSidebar } from "../_components/dashboard-stuffs/app-sidebar";
import { SiteHeader } from "../_components/dashboard-stuffs/site-header";
...
export default function DonorDashboardLayout({ children }: DashboardLayoutProps) {
  return (
    <AuthProvider requiredRole="donor">
      <DashboardContent>
        {children}
      </DashboardContent>
    </AuthProvider>
